...
interface FoodCalculationResultModalProps {
  open: boolean;
  onClose: () => void;
  result: any;
  slipTitle?: string;
...
const FoodCalculationResultModal: React.FC<FoodCalculationResultModalProps> = ({ open, onClose, result, slipTitle, homemadeTotal, selectedRecipes, quantities, paidAmount }) => {
  if (!open) return null;
...
export default FoodCalculationResultModal;
